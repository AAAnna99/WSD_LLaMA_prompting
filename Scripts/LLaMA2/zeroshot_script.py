...
# Estrazione di tutti i sensi possibili da WordNet
...
def extract_predicted_sense(response, wn_senses):
    ...
    match = re.search(r'(?:sense_number|Sense_number|senseNumber|Sense\s*Number\s*[:\-]?\s*)?(\d+)', response_cleaned)
...
if __name__ == "__main__":
    ...
    output_file = "zeroshot_pred_7b.txt"
